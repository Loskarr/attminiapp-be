...
export class TagController {
  ...
  @Get(':id')
  @ApiOperation({ summary: 'Get tag by ID', description: 'Retrieve a tag by its ID' })
  ...
  @Put(':id')
  @ApiOperation({ summary: 'Update a tag', description: 'Update a tag by its ID' })
  @ApiParam({ name: 'id', type: String, description: 'ID of the tag' })
  @ApiBody({ type: Tag })
  ...
  @Delete(':id')
  @ApiOperation({ summary: 'Delete a tag', description: 'Delete a tag by its ID' })
  @ApiParam({ name: 'id', type: String, description: 'ID of the tag' })
